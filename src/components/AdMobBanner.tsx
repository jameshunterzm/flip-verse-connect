 ...
 *
 * Inside the WebToNative Android shell this asks AdMob for a real anchored
 * banner; the spacer keeps page content clear of it. In a plain browser it
 * renders a labelled placeholder so the layout can be reviewed.
 */
